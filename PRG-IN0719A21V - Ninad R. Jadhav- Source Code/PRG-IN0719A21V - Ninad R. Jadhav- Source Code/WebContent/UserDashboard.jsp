...
<div class="col-md-8">
<h3>Welcome, you have logged in successfully <s:property value="Email"/></h3>
...
<center>
  <div class="card-body">
    ...
    <a href="ViewProfilepls" class="btn btn-outline-primary" style="padding: 10px 25px;">My Profile</a></center>
  </div>
</div>
</div>
<div class="col-md-2"></div>
